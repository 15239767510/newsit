...
class Uploader
{
    ...
    {
        $_config = $this->clientDb->name('admin_config')->where(array('group' => 'video'))->field(array('name', 'value'))->select();
        //print_r($_config);
        ...
        try {
            switch ($serverType) {
                ...
                case 'yunzhuanma':
                    ...
                    $currentConfig['yzm_api_secretkey'] = $config['yzm_api_secretkey'];
                    break;
                case 'qiniuyun':
